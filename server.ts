...
async function hydrateStateFromSupabase() {
  ...
  try {
    ...
    if (c && c.length) {
      ...
      const cleanList = c.filter((item: any) => 
...
const deletedCandidateIds = new Set<string>(["cand-test-talentos", "cand-test-oficios"]);
...
const systemRegisteredUsers: Map<string, any> = new Map([
  ["nadia.sitoe@tarira.co.mz", {
    id: "cand-test-talentos",
    email: "nadia.sitoe@tarira.co.mz",
    user_metadata: {
      full_name: "Dra. Nádia Sitoe",
      name: "Dra. Nádia Sitoe",
      role: "profissional",
      phone: "+258 84 123 4567",
      city: "Maputo",
      category: "Directora de Estratégia e Soluções TI",
      candidate_id: "cand-test-talentos"
    },
    role: "profissional"
  }],
  ["mateus.nhaca@tarira.co.mz", {
    id: "cand-test-oficios",
    email: "mateus.nhaca@tarira.co.mz",
    user_metadata: {
      full_name: "Mateus Nhaca",
      name: "Mateus Nhaca",
      role: "prestador",
      phone: "+258 84 987 6543",
      city: "Maputo",
      category: "Técnico Eletricista e Solar Homologado",
      candidate_id: "cand-test-oficios"
    },
    role: "prestador"
  }],
  ["instalacoes@standardbank.co.mz", {
    id: "client-sb-test",
    email: "instalacoes@standardbank.co.mz",
    user_metadata: {
      full_name: "Standard Bank Moçambique",
      name: "Standard Bank Moçambique",
      role: "empresa",
      phone: "+258 21 000 000",
      city: "Maputo",
      client_id: "client-sb-test"
    },
    role: "empresa"
  }],
  ["carlos.mondlane@gmail.com", {
    id: "client-lar-test",
    email: "carlos.mondlane@gmail.com",
    user_metadata: {
