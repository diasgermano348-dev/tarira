...
export const SupabaseAuthModal: React.FC<SupabaseAuthModalProps> = ({
  ...
  return (
    <div 
      ...
      className="fixed inset-0 z-50 overflow-y-auto p-3 sm:p-6 py-6 sm:py-10 bg-slate-950/90 backdrop-blur-md animate-fade-in flex justify-center items-start"
      onClick={(e) => {
