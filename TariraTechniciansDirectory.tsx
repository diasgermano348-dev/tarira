...
export const TariraTechniciansDirectory: React.FC<TariraTechniciansDirectoryProps> = ({
  ...
  return (
    <div id="s-tecnicos-directory" className="flex-1 flex flex-col w-full animate-fade-up max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8 text-[#172554] bg-white">
                ...
                <div className="border-t border-slate-100 pt-3.5 mt-2 space-y-2.5">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    <button
                      ...
                      title="Requisitar intervenção do técnico (Abrir Formulário)"
                    >
      ...
      {isRoleGateModalOpen && (
        <div 
          className="fixed inset-0 z-[100] bg-black/65 backdrop-blur-sm overflow-y-auto p-3 sm:p-6 animate-fade-in"
          onClick={() => {
        ...
        >
          <div className="min-h-full flex items-center justify-center py-16 sm:py-20 pointer-events-none">
            <div 
              data-modal-scroll
              className="pointer-events-auto relative bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl border border-slate-200 text-[#172554] space-y-5 animate-scale-in max-h-[calc(100vh-6rem)] sm:max-h-[calc(100vh-8rem)] overflow-y-auto"
              onClick={(e) => e.stopPropagation()}
            >
            ...
            <div>
              ...
              <p className="text-xs text-slate-600 mt-1.5 leading-relaxed">
                {roleGateAction === "requisitar"
                  ...
                  : "Os perfis completos de técnicos, identificação profissional, documentos, portfólio e localização são exclusivos para utilizadores registados na plataforma. O contacto directo com o técnico é sempre gerido pela Central TARIRA."}
              </p>
            </div>
